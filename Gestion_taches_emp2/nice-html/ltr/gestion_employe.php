            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Gestion d'employés</h4>
                            </div>
                            <div class="row">
                                <div class="col-sm-10"></div>
                                <div class="col-md-2">
                                <a href="add_employe.php">
                                ...
                                echo '<table class="table">
                                    ...
                                    while($row = $result->fetch_array()){
                                        echo "<tr>";
                                            ...
                                            echo "<td>" . $row['idSup'] . "</td>";
                                            echo "<td>";
                                                echo '<a href="update_tache.php?id='. $row['id'] .'">';
                                                echo '<i class="me-2 mdi mdi-grease-pencil"></i>';
                                                echo '</a>';
                                            echo '</td>';
                                            echo '<td><i class="me-2 mdi mdi-delete-forever"></i></td>';
