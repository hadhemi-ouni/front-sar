                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal mt-4 ml-3" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="t_description" name="t_description" class="form-control" rows="5"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Identifiant de l'employé</label>
                                        <input id="t_emp_id" name="t_emp_id" class="form-control" type="number" placeholder="" >
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $idEmploye = trim($_POST["t_emp_id"]);
    
    
    // Check input errors before inserting in database
    
        // Prepare an insert statement
        $sql = 'INSERT INTO tache (description, idEmploye) VALUES (?, ?)';
 
        if($stmt = $mysqli->prepare($sql)){
            // Bind variables to the prepared statement as parameters
            $stmt->bind_param("ss", $param_desc, $param_idEmploye);
            
            // Set parameters
            
            $param_desc = $description;
            $param_idEmploye = $idEmploye;
